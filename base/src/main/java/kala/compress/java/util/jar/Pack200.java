 ...
 */
package kala.compress.java.util.jar;
...
public abstract class Pack200 {
    ...
    public static Packer newPacker() {
        return (Packer) newInstance(SYSTEM_PROPERTY_PACKER, "kala.compress.harmony.pack200.Pack200PackerAdapter"); //$NON-NLS-1$
    }

    /**
     * Returns a new instance of an unpacker engine.
     * <p>
     * The implementation of the unpacker engine is defined by the system property {@link Unpacker}. If this system property is defined an instance of
     * the specified class is returned, otherwise the system's default implementation is returned.
     * </p>
     *
     * @return an instance of {@link Unpacker}.
     */
    public static Unpacker newUnpacker() {
        return (Unpacker) newInstance(SYSTEM_PROPERTY_UNPACKER, "kala.compress.harmony.unpack200.Pack200UnpackerAdapter"); //$NON-NLS-1$
    }
