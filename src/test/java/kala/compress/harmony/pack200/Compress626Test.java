...
import kala.compress.java.util.jar.Pack200;
...
public class Compress626Test {
    ...
    public void testJar() throws IOException {
        try (InputStream inputStream = Files.newInputStream(Paths.get("src/test/resources/kala/compress/COMPRESS-626/compress-626-pack200.jar"));
