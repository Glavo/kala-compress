...
import kala.compress.compressors.xz.XZUtils;
 ...
 * @since 1.21.0.1
 */
final class SnappyCompressor extends CompressorStreamFactory.BuiltinCompressor {
    public SnappyCompressor() {
        super(CompressorStreamFactory.SNAPPY_RAW);
    }
