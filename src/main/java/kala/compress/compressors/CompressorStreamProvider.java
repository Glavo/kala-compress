...
public interface CompressorStreamProvider {
     ...
     *            {@value kala.compress.compressors.CompressorStreamFactory#GZIP},
     *            {@value kala.compress.compressors.CompressorStreamFactory#BZIP2},
     *            {@value kala.compress.compressors.CompressorStreamFactory#XZ},
     *            {@value kala.compress.compressors.CompressorStreamFactory#LZMA},
     *            {@value kala.compress.compressors.CompressorStreamFactory#PACK200},
     *            {@value kala.compress.compressors.CompressorStreamFactory#SNAPPY_RAW},
     *            {@value kala.compress.compressors.CompressorStreamFactory#SNAPPY_FRAMED},
     *            {@value kala.compress.compressors.CompressorStreamFactory#Z}
     *            or
     *            {@value kala.compress.compressors.CompressorStreamFactory#DEFLATE}
     * @param in
     *            the input stream
