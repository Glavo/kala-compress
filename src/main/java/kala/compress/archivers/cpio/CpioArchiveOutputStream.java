...
public class CpioArchiveOutputStream extends ArchiveOutputStream implements
     ...
     *
     * @see
     * kala.compress.archivers.ArchiveOutputStream#closeArchiveEntry
     * ()
     */
    @Override
     ...
     *
     * @see kala.compress.archivers.ArchiveOutputStream#createArchiveEntry(java.io.File, java.lang.String)
     */
    @Override
