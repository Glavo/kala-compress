...
* Align `ZipArchiveEntry` time storage with JDK `ZipEntry` using extended DOS timestamps and nullable modification times, removing the separate modification-time flag.
