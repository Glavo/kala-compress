...
import static kala.compress.archivers.zip.ZipConstants.DATA_DESCRIPTOR_MIN_VERSION;
import static kala.compress.archivers.zip.ZipConstants.DEFLATE_MIN_VERSION;
import static kala.compress.archivers.zip.ZipConstants.DWORD;
import static kala.compress.archivers.zip.ZipConstants.INITIAL_VERSION;
...
import static kala.compress.archivers.zip.ZipConstants.ZIP64_MIN_VERSION;
import static kala.compress.archivers.zip.ZipLong.putLong;
import static kala.compress.archivers.zip.ZipShort.putShort;
 ...
 * SeekableByteChannel} when it knows that the
...
public class ZipArchiveOutputStream extends ArchiveOutputStream {
    ...
    public void setUseLanguageEncodingFlag(final boolean b) {
        useUTF8Flag = b && charset == StandardCharsets.UTF_8;
    }
     ...
     * #ZipArchiveOutputStream(File) File-arg constructor}) -
    ...
    public void finish() throws IOException {
        ...
        final ByteBuffer commentData = Charsets.encode(charset, comment);
    ...
    /*
     * Various ZIP constants shared between this class, ZipArchiveInputStream and ZipArchiveReader
     */
    /**
    ...
    private void writeLocalFileHeader(final ZipArchiveEntry ze, final boolean phased) throws IOException {
        final boolean encodable = Charsets.canEncode(charset, ze.getName());
    ...
    private void addUnicodeExtraFields(final ZipArchiveEntry ze, final boolean encodable,
        ...
        if (comm != null && !"".equals(comm)) {
            ...
            final boolean commentEncodable = Charsets.canEncode(charset, comm);
    ...
    protected void writeCentralDirectoryEnd() throws IOException {
        ...
        // ZIP file comment
        final ByteBuffer data = Charsets.encode(charset, comment);
    ...
    private Charset getEntryEncoding(final ZipArchiveEntry ze) {
        final boolean encodable = Charsets.canEncode(charset, ze.getName());
        return !encodable && fallbackToUTF8 ? StandardCharsets.UTF_8 : charset;
    }
